          ...
          <div class="mt-1 flex items-center gap-x-2">
            @php
                    ...
                    if ($order->status == 'delivered') {
                        $status = '<span class="bg-blue-500 py-1 px-3 rounded text-white shadow">Delivered</span>';
                    }
                    if ($order->status == 'cancelled') {
                        $status = '<span class="bg-blue-500 py-1 px-3 rounded text-white shadow">Cancelled</span>';
                    }
    ...
    <div class="md:w-1/4">
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex justify-between mb-2">
          <span>Subtotal</span>
          <span>{{ Number::currency($order->grand_total, 'KES')}}</span>
        </div>
        <div class="flex justify-between mb-2">
          <span>Taxes</span>
        ...
        <div class="flex justify-between mb-2">
          ...
          <span class="font-semibold">{{ Number::currency($order->grand_total, 'KES')}}</span>
        </div>
